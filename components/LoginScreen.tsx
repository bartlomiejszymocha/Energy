                    ...
                    <div className="mt-10 space-y-6">
                        ...
                        <div className="flex items-start p-4 rounded-xl bg-white/5 border border-white/10">
                            ...
                            <label htmlFor="newsletter-consent" className="ml-3 text-sm text-[#A1A1AA] cursor-pointer leading-relaxed">
                                <span className="font-semibold text-white">⚡️ Rozpocznij darmowy, 6-dniowy kurs energetyczny, by pokonać prokrastynację.</span> Otrzymasz jeden prosty hack dziennie - bez przytłoczenia, krok po kroku.
