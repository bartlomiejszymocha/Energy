...
export const LoginScreen: React.FC<LoginScreenProps> = ({ onSignIn }) => {
    ...
    return (
        <div className="relative flex flex-col items-center justify-center min-h-screen p-6 overflow-hidden bg-[#101113]">
            ...
            <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-[#1E3A8A]/80 via-transparent to-[#1E40AF]/50 z-0"></div>
            ...
            <div className="w-full max-w-md mx-auto z-10">
                <div className="text-center">
                    ...
                    <h1 className="text-4xl font-bold text-white mb-3">Poznaj Energy Playbook!</h1>
                    <p className="text-lg text-gray-300 mb-8">Proste i sprawdzone narzędzie, dzięki któremu <span className="font-bold underline decoration-2 decoration-[#FF6B35]/80 underline-offset-2">odzyskasz 2h produktywności</span> dziennie. Przejmij kontrolę nad swoją energią już dziś!</p>
