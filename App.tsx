...
function App() {
  ...
  return (
    <div className="relative bg-space-950 text-cloud-white min-h-screen font-sans">
      {/* Background gradient overlay - darker version */}
      <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-[#0F172A]/80 via-[#1E293B]/60 to-[#0F172A]/70 z-0"></div>
      
      {/* Stardust pattern background - darker version */}
